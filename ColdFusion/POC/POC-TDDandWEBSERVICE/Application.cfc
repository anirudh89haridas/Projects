...
<cfcomponent output="false" hint="I define application settings and event handlers.">
	...
	<cfset THIS.TestPath=getDirectoryFromPath(getCurrentTemplatePath()) & "Test/"/>
	...
	<cffunction name="StartTest" returntype="any">
		<cfinvoke component="Test.mxunit.runner.DirectoryTestSuite"
			method="run"
			directory="#THIS.TestPath#"
			componentPath="Test"
			recurse="false"
			excludes=""
			returnvariable="results" />
		<cfreturn results.getResultsOutput('html') >
	</cffunction>
